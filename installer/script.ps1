...
$ver=Invoke-RestMethod -Headers $headers -Uri 'https://api.github.com/repos/tyeth/guitar-configurator/tags' | % { $_.name}  | sort -Descending {[version] $_.Substring(1)} | Select-Object -first 1
